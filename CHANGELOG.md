...
### [1.1.1] - 2023-04-14
 ...
 ### [1.6.6] - 2025-06-17
 - Fix to the file names used for the Setup script.

 ### [1.6.7] - 2025-11-03
 - Added more logging.
 - Aligned variable usage to prevent errors.
 - Removes use of old API url.

### [1.9.1] - 2026-09-14
 - Converts remaining event-based ApexSystem APIs to success/failure callbacks.
 - Removes obsolete UnityEvent-based login, user, module, authorization-code, and Quick ID user events.
